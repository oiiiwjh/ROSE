...
- 如果有更新：简短告知用户（如："ROSE 有 N 个系统文件更新可用，运行 `/update` 查看详情"），然后继续处理用户的请求
...
- **文档同步规则**：每次有较大更新（新增/修改 skill、变更数据结构、调整流程等）时，必须同时更新 `README.md`、`CLAUDE.md`、`ROADMAP.md` 等相关文档，确保文档与实际行为一致
